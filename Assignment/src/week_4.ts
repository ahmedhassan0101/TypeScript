...
const showTypes =<T = void, U= void, V = void> (st?: T, n?: U, b?: V) => {
...
// Do Not Edit Here
let game_1 = new GameDetails<string>("Ys", 100);
let game_2 = new GameDetails<number>(2064, 100); // There's A Game Called "2064"
